...
با این ابزار می‌تونید **فایل‌های داخل یک پست مشخص** تلگرام رو دانلود کنید — ویدیو، عکس، PDF، موزیک یا هر فایل دیگه‌ای.
...
├── channels/
│   └── bbcpersian_2026-...md      ← فایل‌های کانال‌ها
├── downloads/
│   └── channelname_123_.../       ← فایل‌های دانلود شده
└── README.md
```
